...
public class ButtonArrow extends GuiButton {
    ...
    private static ResourceLocation ARROW_RIGHT = new ResourceLocation("hyk", "gui/arrowright.png");
    private static ResourceLocation ARROW_LEFT = new ResourceLocation("hyk", "gui/arrowleft.png");
     ...
     */
    public ButtonArrow(double x, double y, HypixelKentik main, ArrowType arrowType, boolean max) {
